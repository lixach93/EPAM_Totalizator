        ...
        <form class="form-inline" method="post" action="<c:url value="totalizator"/>">
            ...
            <div class="form-row">
                <div class="form-group col-md-2 own-form_2">
                    <label for="cdn">
                        <fmt:message bundle="${loc}" key="enter.cardNamber"/>
                    </label>
                    <input class="form-control mr-sm-2" id="cdn" name="cardNumber" type="tel" pattern ="([\d]{4}\s[\d]{4}\s[\d]{4}\s[\d]{4})|(\d{4}){4}" maxlength="19" placeholder="<fmt:message bundle="${loc}" key="input.cardNumber" />" aria-label="Card Number" required>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-2 own-form_2">
            ...
            <div class="form-row">
                <div class="form-group col-md-2 own-form_3">
